...
CompareEfficiencies([EleVLooseMVA6,EleLooseMVA6,EleMediumMVA6,EleTightMVA6,EleVTightMVA6],['Very Loose','Loose','Medium','Tight','Very Tight'],'tauPt',[30,0,120], 'tau_DYtoTauTau_effi_pT',"p^{e}_{T} (GeV)")
