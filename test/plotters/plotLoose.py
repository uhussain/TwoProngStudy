...
compare_efficiencies(
	            byLooseCmbIso3_03, 'Loose dBIso 0.3', 
	            byLooseCmbIso3_05, 'Loose dBIso 0.5', 
	            byLooseCmbIso3_08, 'Loose dBIso 0.8', 
		    byLooseCmbIso3_1,'Loose dBIso 1',
		    byLooseCmbIso3_5,'Loose dBIso 5',
		    'tauPt', 20, [20, 0, 120],#variable, ptcut, binning
                    'tauPtLooseCmbIso3',#filename
                    "byLooseCombIsoDBSumPtCorr3Hits",#title
                    "pf Tau p_{T} (GeV)",#xaxis
                    "efficiency" #yaxis             
)
compare_efficiencies(
	            byLooseCmbIso_03, 'Loose dBIso 0.3', 
	            byLooseCmbIso_05, 'Loose dBIso 0.5', 
	            byLooseCmbIso_08, 'Loose dBIso 0.8', 
		    byLooseCmbIso_1,'Loose dBIso 1',
		    byLooseCmbIso_5,'Loose dBIso 5',
		    'tauPt', 20, [20, 0, 120],#variable, ptcut, binning
                    'tauPtLooseCmbIso',#filename
