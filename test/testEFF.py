...
options.outputFile = "testTau_effi_wjet.root"

options.register ('isoDBFactor',  0.4579, VarParsing.multiplicity.singleton, VarParsing.varType.float,
                  "deltaBetafactor")
...
print 'deltaBetafactor =   ',options.isoDBFactor,''
